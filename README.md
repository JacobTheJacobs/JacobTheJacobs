...
| **TradingAgents Control Room** | **Multi-agent trading floor** — AI analysts debate a stock live in **pixel-art**: analysts → bull/bear debate → trader → risk → decision. React + Phaser + FastAPI, data from the **Fin-Node** CDN. | [GitHub](https://github.com/JacobTheJacobs/TradingAgents-Control-Room) · [Live API](https://www.fin-node.net/api) |
